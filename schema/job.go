...
type Job struct {
	...
	Company  string    `gorm:"column:Company;type:varchar(20);NOT NULL"`
	JobId    string    `gorm:"column:JobId;type:varchar(40);UNIQUE;NOT NULL"`
	Keyword  string    `gorm:"column:Keyword;type:varchar(20);NOT NULL"`
	Title    string    `gorm:"column:Title;type:varchar(40);NOT NULL"`
	Salary   string    `gorm:"column:Salary;type:varchar(40)"`
	Content  string    `gorm:"column:Content;type:text"`
	Link     string    `gorm:"column:Link;type:varchar(256);NOT NULL"`
	Website  string    `gorm:"column:Website;type:varchar(12);NOT NULL"`
